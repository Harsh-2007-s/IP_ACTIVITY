...
# =============================
    ...
    # Bottom → Matrix and Histogram side-by-side
...
# =============================
    ...
    st.title("Equalization – Step by Step")
    ...
    if st.session_state.eq_step < steps:
        ...
        st.success("Equalization Complete ✅")

        st.markdown("---")
        st.subheader("All Iterations History")
